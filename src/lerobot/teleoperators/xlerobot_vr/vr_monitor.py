...
XLEVR_PATH = "/home/cics/Desktop/codes/projects/XLeRobot/XLeVR"
...
class SimpleAPIHandler(http.server.BaseHTTPRequestHandler):
    ...
    def end_headers(self):
        ...
        with contextlib.suppress(BrokenPipeError, ConnectionResetError, ConnectionAbortedError, ssl.SSLError):
            super().end_headers()
    ...
    async def start(self):
        ...
        try:
            ...
            self.httpd = http.server.HTTPServer(
                (self.config.host_ip, self.config.https_port), SimpleAPIHandler
            )
...
class VRMonitor:
    ...
    def initialize(self):
        ...
        # Import modules
        XLeVRConfig, VRWebSocketServer, ControlGoal, ControlMode = import_xlevr_modules()  # noqa: N806
